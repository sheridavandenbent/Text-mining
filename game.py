...
def game():
    ...
    global gamesplayed
    global roundsplayed
    global computerroundscorrect
    global playerroundscorrect
    global computerwins
    global ties
    global playerwins
    ...
    for i in range(0, gamelength):
        ...
        print(text)
        print("Is it:")
        print("A: ", roundartists[0])
        print("B: ", roundartists[1])
        print("C: ", roundartists[2])
        print("D: ", roundartists[3])
        ...
        while userinput != "A" and userinput != "B" and userinput != "C" and userinput != "D":
            print(userinput)
            print("whoops! Try again! Please answer only with a capital letter A, B, C or D!")
            userinput = input('--> ')

        print("The correct answer was ", correctanswer, ", your answer was ", userinput, " and the computers answer was ", computeranswer,".")
    ...
    print("And now the final score:")
    print("You: ", playerscore)
    print("Computer: ", computerscore)
    computerroundscorrect += computerscore
    playerroundscorrect += playerscore
    roundsplayed += 10
    gamesplayed += 1
    if (playerscore > computerscore):
        ...
        computerwins += 1
        print("You did not beat the computer! Try again...")
...
gamesplayed = 0
roundsplayed = 0
computerroundscorrect = 0
playerroundscorrect = 0
computerwins = 0
ties = 0
playerwins = 0
...
while True:
    ...
    print("Computer got questions correct:", computerroundscorrect)
    print("Player got questions correct:", playerroundscorrect)
    print("Computer won the game:", computerwins)
    print("Ties:", ties)
    print("Player won the game:", playerwins)
    print()
